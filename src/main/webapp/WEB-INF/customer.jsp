...
<nav class="navbar navbar-expand-sm bg-light">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" href="${app}/adminuser/adminpage">管理员用户管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/customer/customerpage">用户管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/categorys/categoryspage">商品类别管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/business/businesspage">商家管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/promotion/promotionpage">活动管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/goods/goodspage">商品管理</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${app}/orderlist/orderlistspage">订单管理</a>
        </li>
    </ul>
</nav>
<hr/>
